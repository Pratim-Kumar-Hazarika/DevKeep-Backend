...
exports.add_image_to_notes = async (req, res) => {
    try {
        ...
        await Note.updateOne({ "_id": decodedValues.userId, "notes._id": req.body.noteId }, {
          "$addToSet": {
            "notes.$.images": {"imageUrl":uplodedResponse.secure_url}, 
          }
      }, { upsert: true })
  ...
  exports.add_image_to_pinned_notes = async (req, res) => {
    try {
        ...
        "$addToSet": {
          "pinnedNotes.$.images": {"imageUrl":uplodedResponse.secure_url},
        }
      }, { upsert: true })
  ...
  exports.add_image_to_archive_note = async (req, res) => {
    try {
        ...
        "$addToSet": {
          "archiveNotes.$.images": {"imageUrl":uplodedResponse.secure_url},
        }
      }, { upsert: true })
